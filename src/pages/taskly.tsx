...
export default function SingleProjectPage() {
  ...
  const project = {
    ...
    details: [
      "Full-stack SPA task manager with create, update, delete, and manage task features.",
      "MVC architecture for clean, scalable code.",
      "Interactive analytics dashboards with bar, pie, and donut charts.",
      "Responsive tables with search, filter, update, delete, and pagination.",
      "Secure authentication with Laravel Sanctum and guest/auth guards.",
    ],
    liveUrl: "https://taskly-d79v.onrender.com/",
    githubUrl: "https://github.com/pinkypon/Taskly-App",
  };
